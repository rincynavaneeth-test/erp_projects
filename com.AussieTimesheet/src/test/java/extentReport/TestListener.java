...
public class TestListener extends BaseClass implements ITestListener {
	...
	private static ExtentReports extent = ExtentManager.createInstance(); // This creates a static obj of the
																			// ExtentReports class.
	private static ThreadLocal<ExtentTest> test = new ThreadLocal<>(); // each testcase will have dfrnt extenttese
																		// object

	public synchronized void onStart(ITestContext context) { // method after testng start
	...
	public synchronized void onTestStart(ITestResult result) { // before each @text execution
	...
	private String captureScreenshot(String methodName) {
		try {
			...
			String screenshotPath = System.getProperty("user.dir") + "/TestReport/Screenshots/" + methodName + timeStamp
					+ ".png";
